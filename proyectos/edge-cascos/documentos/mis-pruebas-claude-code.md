...
| 12 | [Hero — verificación ficha vs. excel maestro](simulaciones-cc/simulacion-12-hero-verificacion.md) | Etapa 3 — Catálogo | 🔴 9 de 13 claims sin dato, "diseño modular" contradice "open face" confirmado — Prompt A bloqueado (1 solo ítem confirmado), Prompt B generable en versión reducida de 4 ítems |
