...
37. **Confirmar los 2 ítems de reemplazo elegidos:** "Interior EPS de alta resistencia" en la tarjeta de homologación y "Material exterior ABS alta resistencia" en el grid (suplente descartado con motivo: "4 VENTILACIONES", dato numérico verificable a ojo, mismo criterio que en Stellar #21).
38. Subir la ficha real del Boston y la hoja "FICHA DE CASCOS" como adjunto real para versionarlas.
...
**Total: 44 puntos registrados**, de los cuales **7 ya están cerrados** (#19 Stellar, #24 Shift, #35 y #36 Boston, #39 Boston 4.0, y los #41 a #44 de los casos de ilustración cerrados el 2026-07-29 — el #36 y el #39 son la misma decisión de certificación vista desde los dos archivos). Quedan **abiertos ~35 puntos** repartidos en los 13 casos, más el punto sin numerar de la falta de ortografía "HOMOLOGACÓN" del caso Hero —cuya **2ª aparición confirmada** es la ficha del Boston, ahora en la otra hoja—. El detalle completo de cada uno está en la sección "🔴 Pendiente de tu parte" / "Qué hay que hacer" del archivo correspondiente.
