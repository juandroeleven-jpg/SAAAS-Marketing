...
| 4 — Escena generada alrededor de un casco real | Generación de una escena lifestyle nueva desde cero con el casco exacto de una foto de producto | [familia-4-escena-generada.md](familia-4-escena-generada.md) | 1 (mujer bajándose de la moto, jet samurái, visor transparente) |
...
**Última actualización:** 2026-07-29 — creado el catálogo con las Familias 1 y 2; agregadas la Familia 3 (goma inferior a negro, 4 instancias del molde dual-sport) y la Familia 4 (escena generada alrededor de un casco real).
