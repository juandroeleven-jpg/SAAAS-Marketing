...
- **[Orquestación de agentes en paralelo](documentos/orquestacion-agentes-paralelos.md)** — plantilla reutilizable: roles Agente 0 / Generador / Auditor, tipos de prompt (transferencia de diseño vs. layout fijo), estructura de carpetas por caso, registro de casos activos (Dakota, tarjetas de homologación)
